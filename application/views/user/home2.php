...
<body id="header" onload="setInterval('reloadwaktu()');">
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
					...
					<li class="nav-item">
						<a class="nav-link" href="javascript::" data-toggle="modal" data-target="#modalDiproses"> Status
							Pemesanan</a>
					</li>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="form-group">
							...
							<input type="number" name="qty" min="1" max="" class="form-control" value="<?= $key['qty']; ?>"
								id="qty<?= $key['qty']; ?>" autofocus>
	...
	<div class="modal fade" id="modalDiproses" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
		aria-hidden="true">
