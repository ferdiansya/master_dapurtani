        ...
        <div class="row justify-content-md-center pt-4 pb-4">
          <div class="col-lg-6 col-sm-6 col-md-6">
            ...
            <div class="card">
              ...
              <?php } else { ?>
                    <input class="form-control" type="hidden" name="sub" value="Rp. <?= number_format($this->cart->total(), 0, ',', '.'); ?>">
                    <input class="form-control" type="hidden" name="total" value="Rp. <?= number_format($this->cart->total() + 9000, 0, ',', '.'); ?>" readonly>
                      <?php } ?>
                  </div>
            </div>
        </div>
      ...
      <div class="isi-box-beli justify-content-center">
        ...
        <div class="col-sm-5">
          ...
          <?php } else { ?>
            ...
            <td colspan="2">Rp. <?= number_format($this->cart->total(), 0, ',', '.'); ?></td><tr>
            <td colspan="2">Ongkir</td>
            <td colspan="2">RP. 9.000</td><tr>
            <td colspan="2">Total</td>
            <td colspan="2">Rp. <?= number_format($this->cart->total() + 9000, 0, ',', '.'); ?></td></tr>
          <?php } ?>
            </tbody>
          </table>
                  ...
                  <div class="card form-transfer">
                    ...
                    <div class="card-body">
                      ...
                      <p style="text-align: center; font-size: 15px;">
                        Total pembayaran :
                        <br />
                        <span style="color: #73C089">Rp. <?= number_format($this->cart->total() + 9000, 0, ',', '.'); ?></span>
                        <br />
