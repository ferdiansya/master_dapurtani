	...
	<div class="x_content">
		<table class="table table-striped table-bordered dt-responsive nowrap" id="datatable">
           ...
           ?>
					...
					<td>
						<a href="<?= base_url(); ?>s_pengiriman/edit/<?= $pengiriman->id_order; ?>"
							class="btn btn-success">diantar</a>
						<a href="<?= base_url(); ?>s_pengiriman/edit_diterima/<?= $pengiriman->id_order; ?>"
							class="btn btn-primary">diterima</a>
						<a href="<?= base_url(); ?>s_pengiriman/edit_batal/<?= $pengiriman->id_order; ?>"
							class="btn btn-danger">batal</a>
						<a href="<?= base_url(); ?>s_pengiriman/detail/<?= $pengiriman->id_order; ?>" class="btn btn-primary">detail
							sayur</a>
						<a href="<?= base_url(); ?>s_pengiriman/hapus/<?= $pengiriman->id_order; ?>" class="btn btn-danger"
							onclick="return confirm('Yakin Ingin menghapus item ini dari keranjang anda ?')"><i
								class="fa fa-trash"></i></a>
					</td>
					<td><a href="<?= base_url(); ?>user/update_user/<?= $pengiriman->id_user; ?>" class="btn btn-warning"><i
